...
local globalKeys =
  ...
  awful.key({modkey}, 'w', awful.tag.history.restore, {description = 'go back', group = 'tag'}),
  ...
  awful.key(
    ...
    function()
      ...
      awful.util.spawn_with_shell('sleep 0.5 && scrot ~/Pictures/Screenshots/%Y-%m-%d-%T-screenshot.png -s')
    end
  ),
  -- Standard program
  awful.key(
  ...
  awful.key(
    ...
    {description = 'Power', group = 'hotkeys'}
  ),
  awful.key(
    {},
    'XF86PowerOff',
