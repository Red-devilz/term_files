...
function conky_draw_text1()
    text_settings={
        --BEGIN OF PARAMETERS        
        {
        text=conky_parse('_________________'),
        x=325,
        y=353,
        font_name="monospace",
        font_size="20",
...
{
        text=conky_parse('____________________'),
        x=330,
        y=153,
        font_name="monospace",
        bold=true,
...
{
        text=conky_parse('______________________'),
        x=342,
        y=140,
        font_name="monospace",
        bold=true,
...
{
        text=conky_parse('___________________'),
        x=339,
        y=363,
        font_name="monospace",
        bold=true,
